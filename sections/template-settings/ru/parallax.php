...
<p>Чтобы использовать параллакс-эффект на странице, необходимо перейти в "Менеджер
...
<p>где [значение] - коэффициент относительно естественной скорости скроллинга, более
...
<p>После проделанных операций на соответствующей странице появится параллакс-эффект на
    соответствующем блоке.</p>
