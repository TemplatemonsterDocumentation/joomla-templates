...
<p>Для реализации фонового видео в шаблоне используется jQuery-плагин <a
        href="http://vodkabears.github.io/vide/" target="_blank" rel="nofollow">Vide</a>.
    Проверьте, подключен ли плагин в шаблоне. Для этого перейдите в "Менеджер шаблонов
    ...
    как показано  Также проверьте наличие самого плагина в папке "js". Если
