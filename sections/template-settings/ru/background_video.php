...
<p>Для добавления фонового видео в шаблоне используется jQuery-плагин <a
        href="http://vodkabears.github.io/vide/" target="_blank" rel="nofollow">Vide</a>.
    Заранее проверьте, подключен ли плагин к данному шаблоне. Для этого перейдите в "Менеджер шаблонов    > Шаблоны", затем перейдите в используемый шаблон (Theme**** Details and Files) и
    откройте файл "index.php", проверьте подключение плагина, оно должно быть таким же,
    как показано в данном окне. </p>
<p>Также проверьте наличие самого плагина в папке "js". Если
...
<p>Чтобы вставить фоновое видео на страницу, необходимо перейти в "Менеджер шаблонов ->
...
<p>Также необходимо подготовить видео в форматах mp4, ogv, webm и постер к видео в
...
<p>Далее необходимо создать модуль для отображения видео. Создаем модуль HTML-код
