<h3>Tableau de configuration</h3>

<p class="alert alert-warning">Veuillez noter : Si vous avez installé les données de test du modèle ou utilisé la méthode
    d'installation complète, vous pouvez sauter l'étape suivante étant donné qu'elle se rapporte à la configuration
    manuelle de modules.</p>

<p>Le tableau ci-dessous liste tous les modules utilisés dans ce modèle et montre
    comment les configurer correctement. Tous les modules sont accessibles via le
    panneau d'administration de Joomla, sur la page « <b>Extensions > Gestionnaire de
        modules</b> » (« <b>Extensions > Module Manager</b> »).</p>
