<h3>Modüller Konfigürasyon Tablosu</h3>

<p class="alert alert-warning">Lütfen Dikkat: Komple kurulum şablon yönetimi örnek veriler yüklü yada kullandıysanız bu
    manuel modülleri yapılandırma ile ilgili olarak aşşağıda belirtilen adımları atlayabilirsiniz.</p>

<p>Aşşağıdaki tablo, bu şablon ile kullanılan tüm modülleri listelemektedir ve bunları
    doğru şekilde nasıl yapılandıracağınızı göstermektedir. Tüm modüllere <b>Extensions
        > Module Manager</b> - (<b>Eklentiler > Modül Yöneticisi</b>) ekranından Joomla
    yönetim paneli içerisinden erişim saşlayabilirsiniz.</p>
