<h3>Tabella di Configurazione dei Moduli</h3>

<p class="alert alert-warning">Attenzione: Il passaggio seguente potrà essere saltato nel caso in cui abbiate installato i
    dati di esempio del modello o eseguito una Installazione Completa essendo collegato alla configurazione manuale dei
    moduli.</p>

<p>La tabella in basso elenca tutti i moduli utilizzati in questo modello e mostra il
    loro criterio di configurazione corretta. E’ possibile accedere a qualsiasi modulo
    tramite il pannello di Amministrazione Joomla dalla voce <b>Extensioni>Gestione
        Moduli ( Extensions > Module Manager).</b></p>
...
<div class="table">
    <div class="container">
        ...
        <div class='row'>
            <div class='grid_4'>Login Form</div>
        ...
        <div class='row'>
            <div class='grid_4'>Breadcrumbs</div>
        ...
        <div class='row'>
            <div class='grid_4'>Copyright</div>
        ...
        <div class='row'>
            <div class='grid_4'>Archived Articles</div>
        ...
        <div class='row'>
            <div class='grid_4'>Superfish Menu</div>
        ...
        <div class='row'>
            <div class='grid_4'>Camera Slideshow</div>
        ...
        <div class='row'>
            <div class='grid_4'>Social Media</div>
        ...
        <div class='row'>
            <div class='grid_4'>Categories</div>
        ...
        <div class='row'>
            <div class='grid_4'>carouFredSel</div>
        ...
        <div class='row'>
            <div class='grid_4'>Article Single</div>
        ...
        <div class='row'>
            <div class='grid_4'>Komento Activities</div>
        ...
        <div class='row'>
            <div class='grid_4'>Komento Comments</div>
        ...
        <div class='row'>
            <div class='grid_4'>mod_twitter_widget</div>
