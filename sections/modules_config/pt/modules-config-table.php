<h3>Mesa de Configuração de Módulos</h3>

<p class="alert alert-info">Por favor, observe: Se você instalou os dados de amostra de template ou usou o método de
    instalação Completo, você pode pular a seguinte etapa, pois ela é relacionada a configuração dos módulos
    manuais.</p>

<p>A mesa abaixo lista todos os módulos no template e mostra como configurá-los
    corretamente. Todos os módulos podem ser acessados através da tela do painel de
    Administração do Joomla <b>Extensões > Gerenciador de Módulo </b> (em Inglês, &quot;Extensions
    &gt; Module Manager&quot;).</p>
