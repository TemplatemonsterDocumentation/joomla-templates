...
<p align="justify"> At <a href="http://extensions.joomla.org/" target="_blank">extensions.joomla.org</a> you can download more than 6 thousand modules, plugins and components to add various features to your Joomla website.</p>
<h4>Joomla! Cookies usage warning</h4>

<p align="justify"> Following the Cookie Law conditions, you should add appropriate modules to your website that will display a warning message about the cookies used on your website. We can recommend the following ones:</p>
<ul class="marked-list">
  <li>
