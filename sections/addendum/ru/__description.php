...
<p>Надеемся, что информация, изложенная в документации была доступной и понятной. Тем не
...
<h4>Способы решения возможных проблем связаных с веб-шрифтами </h4>
...
<p>Для этих же целей Вы можете использоваль локальную копию библиотеки jQuery.</p>

<h4>Joomla! Модули и расширения</h4>

<p>На сайте <a href="http://extensions.joomla.org/" target="_blank">extensions.joomla.org</a> можно скачать более 6 тысяч модулей, плагинов и компонентов, позволяющих расширять стандартный функционал платформы Joomla.</p>
