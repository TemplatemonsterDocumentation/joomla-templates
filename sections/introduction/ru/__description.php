...
<p>Joomla CMS - это открытое программное обеспечение для построения веб-сайтов. Оно позволяет создавать веб-сайты и
...
<p>Шаблон Joomla - это тема для платформы Joomla CMS. Другими словами, внешний вид веб-сайта Joomla можно легко изменить
    путем установки нового шаблона за несколько несложных шагов. При всей своей простоте, шаблон Joomla содержит все
...
<ul class="files_structure">
    ...
    <li class="file">
        <dl class="inline-term">
            ...
            <dd> содержит ссылки для скачивания всех недостающих шрифтов шаблона;
            </dd>
        </dl>
    </li>
    <li class="file">
