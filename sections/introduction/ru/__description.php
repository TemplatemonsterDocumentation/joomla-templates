...
мощные онлайн приложения. Для создания сайтов с Joomla CMS не требуется почти никаких технических навыков или знаний в сфере управлении сайтами. Все необходимые базовые навыки и знания будут детально описаны в этой документаци, так что любой  неподготовленный пользователь, в последствии, сможет с успехом пользоваться всеми возможностями платфомы Joomlа. </p>
<p>Множество
  особенностей, в том числе простота в использовании и расширяемость фунционала системи, сделали Joomla популярной программой для создания
...
<p align="justify">Шаблон Joomla – это тема для сайта созданного на платформе Joomla CMS. Другими словами, внешний вид веб-сайта Joomla можно  изменять
    ...
    необходимые исходные файлы, которые, прижелании, можно редактировать желаемым образом.</p>
        ...
        <ul>
            <li class="file">
                <dl class="inline-term">
                    ...
                    <dd> архив с темой. В нем содержатся все  файлы темы. Нужно устанавливать
        ...
        <ul>
            ...
            <li class="folder">
                <dl class="inline-term">
                    ...
                    <dd> папка с образцами всех данных, необходимых, для того чтобы веб-сайт выглядел идентично демо-версии шаблона. Содержимое
