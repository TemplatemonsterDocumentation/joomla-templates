...
<p align="justify">Joomla CMS is an open-source solution for creating websites. Wide functionalities of the system allow you to build both websites and powerful online applications. Joomla CMS would not need any additional skills and training to be operated. All the necessary theory and basic required skills description can be found in this documentation.</p>
<p align="justify"> With these advantages, ease of use and its scalability, Joomla CMS became the most popular website software available. <a href="http://www.joomla.org/about-joomla.html" target="_blank">Learn More!</a>
</p>
...
<div align="justify">There are often many different settings that are available with a new Template, and as this is an open-source software, it isn't always the same for each developer. Make sure to read through this documentation available for the Template that you are installing so that you know what features are available for you.</div>
</div>
