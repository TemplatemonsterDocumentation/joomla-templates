...
<h5>Таблица параметров модулей</h5>
<p align="justify" class="alert alert-warning">Внимание: Если вы устанавливали демо-данные шаблона или использовали метод полной установки,
  можете пропустить данный шаг, поскольку он представляет собой ручную настройку модулей.</p>
<p align="justify">Следующая таблица предоставляет собой список всех модулей, использованных в шаблоне Jumerix, и перечисляет  параметры их 
  настройки в данном шаблоне. Доступ к модулям можно получить через  админ-панель Joomla, в меню<b> Extensions
