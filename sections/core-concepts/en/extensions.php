<h3>Extensions</h3>
<div align="justify">Joomla provides all the functionality you need for a simple site, but if you require
  some specific functionality you can often find what you need with an Extension
  from a third party developer.  </div>
<h4>The Five Types of Extensions</h4>
...
<h5>Plugins</h5>
<p align="justify">As their name suggests, Plugins add content or functionality to a page or content item. Some Plugins work in the background of a page and can add additional code, such as Google Analytics tracking. Other Plugins may be activated within a specific type of Article or Module, for instance to provide commenting to an Article.</p>
<p><strong>Examples:</strong> Content - Load Modules, Editor - TinyMCE.</p>
<p><strong>Management feature:</strong> <em>Admin head menu</em> &gt; <strong>Extensions</strong> &gt; <strong>Plugins</strong>.</p>
<figure class="img-polaroid">
    <img src="img/extensions-3.jpg" alt="">
</figure>
<h5>Templates</h5>
<p align="justify">You are also already familiar with Templates, which provide different layouts for a website and are managed through the Template Manager.</p>
<p align="justify"><strong>Management feature:</strong> <em>Admin head menu</em> &gt; <strong>Extensions</strong> &gt; <strong>Templates</strong>.</p>
<figure class="img-polaroid">
