...
<p><strong>TM Ajax Style Switcher Module</strong> – это модуль позволяющий переключать цветовые схемы на фронтенде
...
<p class="alert alert-warning">Обратите внимание, что на демо шаблона модуль работает в демонстрационном режиме,
