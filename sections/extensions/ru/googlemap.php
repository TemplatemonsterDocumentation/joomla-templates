...
<p align="justify"><strong>Чтобы  перейти к настройке модуля, пройдите к разделу  Extensions &gt; Plugins. Перед вами откроется окно  Plugins Mameger. Введите &quot;Google&quot; в поле поиска, нажмите кнопку поиска и в таблице менеджера вы увидите плагин System - Google Maps, прейдите по ссылке его заголовка.</strong></p>
<figure class="img-polaroid">
