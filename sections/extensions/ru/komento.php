...
<p align="justify">При помощи настроек компонента, можно активировать комментарии для определенных
    категорий и статей, добавить captcha (компьютерный тест, используемый для того, чтобы определить, кем является пользователь системы: человеком или компьютером, желаещему оставить комментарий предлагаетмя ввсести символы из картинки), профили пользователей и т.п. Более детальную
