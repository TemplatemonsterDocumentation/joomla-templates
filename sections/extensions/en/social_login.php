...
<p>Joomla Social Login - component that allows to display login buttons to the social
    network accounts.</p>
...
<p>Here you can see the main Joomla Social Login settings. Feel free to check more
    details at the <a
