...
<p><strong>GoogleMap</strong> is a plugin that allows  displaying Google map on your website:</p>

<figure class="img-polaroid">
    <img src="img/googlemap-1.jpg" alt="">
</figure>

<p align="justify"><strong>To customize the plugin go to Extensions &gt; Plugins. This will bring you to the Plugins Mameger. Type &quot;Google&quot; in the search field and click the System - Google Maps title link.</strong></p>
<figure class="img-polaroid">
...
<table width="980"  class="options-table">
  <tr>
        ...
        <td width="29">-</td>
        <td width="781">If not then all maps will disappear.</td>
  </tr>
    <tr>
        ...
        <td>-</td>
        <td>The code which is used to be placed in the article between {} to trigger plugin. Default mosmap.</td>
    </tr>
    <tr>
