...
<ol class="marked-list">
  ...
  <li>
    <div align="justify"><strong>Module Ordering</strong>. This shows a drop down of every module in   the position that the current module is in. This is the order that the   modules will display in when displayed on in the front end as well as in   the Module Manager.</div>
  </li>

  <li>
    <div align="justify"><strong>Start Publishing</strong>. Date and time to start publishing. Use this   field if you want to enter content ahead of time and then have it   published automatically at a future time.</div>
  </li>
...
<figure class="img-polaroid">
  ...
  <p align="justify">After all these steps are accomplished, you will  see the  following on the Blog page of your web-site:</p>
  <figure class="img-polaroid">
