...
<p align="justify"><strong>Komento</strong> is a separate component, used to manage comments in. It is highly secured, lightweight and compatible with all Joomla versions and it is free to download.</p>
<p>Komento is a comments component for Joomla. It allows adding comments to 
  Joomla articles:</p>
...
<figure class="img-polaroid"><img src="img/komento-3.jpg" alt=""></figure>
  ...
  <li>
    <p align="justify">In the General tab you can <strong>Enable</strong> or <strong>Disable</strong> comments. You can also change <strong>Moderation</strong> and other settings. We have disabled comments (check the screenshot below).</p>
  </li>

    <figure class="img-polaroid"><img src="img/komento-5.jpg" alt=""></figure>

  <li><p>We have <strong>disabled</strong> (No) comments (check the screenshot below). </p></li>

    <figure class="img-polaroid"><img src="img/komento-6.jpg" alt=""></figure>
  
 <li> <p>The comments block will be disabled on the website.</p></li>
...
<figure class="img-polaroid"><img src="img/komento-7.jpg" alt=""></figure>
  ...
  <li>
    <p align="justify">You can also <strong>disable</strong> comments for a particular article. Open the article in the <strong>Article Manager (Content &gt; Articles)</strong> and insert the following code to the article body:</p>
    <pre>{KomentoDisable}</pre>
  </li>
  <figure class="img-polaroid"><img src="img/komento-10.jpg" alt=""></figure>
  <li>
    <p>Save changes. Comments do not appear on that article.</p>
  </li>
</ol>
...
<ol class="marked-list">
  ...
  <figure class="img-polaroid"><img src="img/komento-4.jpg" alt=""></figure>
  <li>
    <p>Then switch to <strong>Layout</strong> section and go to<strong> Comment Form</strong> tab:</p>
  </li>
...
<p>Text was successfully changed:</p>
