...
<p align="justify">При помощи этого метода устанавливаются непосредственно сам движок Joomla CMS, шаблон Joomla, демо-данные и все требуемые расширения (приложения, модули).</p>
...
<p align="justify">Для этого, откройте браузер и пропишите путь к директории Joomla в адресной строке браузера (<i>например http://your_domain_name/joomla</i>). На экране должно появиться окно установки Joomla CMS:
</p>
