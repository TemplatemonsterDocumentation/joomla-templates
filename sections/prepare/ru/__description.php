...
<p>Для полноценной работы с шаблоном Joomla мы рекомендуем установить все требуемые
...
<ol class="index-list">
    <li>Прежде всего нужны  приложения для распаковывания защищенного паролем
        архива sources_#########.zip. Можно воспользоваться архиваторами WinZip 9+ (для Windows) и
        Stuffit Expander 10+ (для системы Mac).
    </li>
    <li>Также может понадобиться Adobe Photoshop. Этот графический редактор используется для
        изменения исходных файлов .psd (измения
        графического дизайна и изображения шаблона).
    </li>
    <li>Для редактирования исходного кода файлов шаблона нужно использовать редакторы
        кода, например, такие как: Adobe Dreamweaver, Notepad++ или Sublime Text и прочие.
    </li>
    <li>Чтобы загрузить файлы на хостинг сервер, вам потребуется FTP менеджер, например, такой как
...
<p>Поскольку Joomla CMS является приложением PHP/MySQL, необходимо заранее подготовить хостинг
    сервер.</p>

<p>При наличии уже активного сервера, необходимо проверить его на соответствие <a
        ...
        Joomla </a> , а также на совместимость с платвормой Joomla.</p>

<p> Установить Joomla на компьютер можно с помощью локального сервера. Для
...
<p>Вы можете воспользоваться следующими видео-уроками, в которых детально описывается локального
    сервера:</p>
